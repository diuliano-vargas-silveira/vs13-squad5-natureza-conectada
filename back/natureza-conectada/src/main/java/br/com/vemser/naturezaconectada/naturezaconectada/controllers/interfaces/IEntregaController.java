...
public interface IEntregaController {
    ...
    ResponseEntity<EntregaResponseDTO> editarMudasDaEntrega(@PathVariable("idEntrega") Integer id, @Valid @RequestBody EntregaRequestDTO entregaRequestDTO) throws Exception;
