...
(
    ...
    CONSTRAINT FK_ID_USUARIO_CONTATO FOREIGN KEY (ID_CONTATO) REFERENCES CONTATO (ID_USUARIO)
    CONSTRAINT FK_ID_USUARIO_ENDERECO FOREIGN KEY (ID_ENDERECO) REFERENCES ENDERECO (ID_ENDERECO)
);
...
(
    ...
    CONSTRAINT FK_ID_ESTADO_ FOREIGN KEY (ID_ESTADO) REFERENCES ESTADO (ID_ESTADO)
);
